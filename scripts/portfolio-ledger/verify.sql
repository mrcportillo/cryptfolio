...
BEGIN
  ...
  WITH expected(
    ...
    VALUES
      ...
      ('User', 'ledgerAdoptedAt', 'timestamp', 'YES', NULL::text, NULL::integer, NULL::integer, NULL::integer, 3),
      ('User', 'ledgerRevision', 'int8', 'NO', '0', 64, 0, NULL::integer, NULL::integer),
      ...
      ('UserAsset', 'archivedAt', 'timestamp', 'YES', NULL::text, NULL::integer, NULL::integer, NULL::integer, 3),
      ('UserAsset', 'ledgerInitialAssetName', 'varchar', 'YES', NULL::text, NULL::integer, NULL::integer, 80, NULL::integer),
      ...
      ('PortfolioEvent', 'id', 'text', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'userId', 'text', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'kind', 'PortfolioEventKind', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'occurredAt', 'timestamp', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, 3),
      ('PortfolioEvent', 'externalFlowUsd', 'numeric', 'YES', NULL::text, 65, 30, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'feeUsd', 'numeric', 'YES', NULL::text, 65, 30, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'idempotencyKey', 'varchar', 'NO', NULL::text, NULL::integer, NULL::integer, 160, NULL::integer),
      ('PortfolioEvent', 'openingForUserAssetId', 'text', 'YES', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'reversalOfEventId', 'text', 'YES', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'createdAt', 'timestamp', 'NO', 'CURRENT_TIMESTAMP', NULL::integer, NULL::integer, NULL::integer, 3),
      ('PortfolioEvent', 'actualValueUsd', 'numeric', 'YES', NULL::text, 65, 30, NULL::integer, NULL::integer),
      ('PortfolioEvent', 'note', 'varchar', 'YES', NULL::text, NULL::integer, NULL::integer, 500, NULL::integer),
      ('PortfolioEvent', 'replacementForEventId', 'text', 'YES', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('AssetMovement', 'id', 'text', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('AssetMovement', 'userId', 'text', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('AssetMovement', 'portfolioEventId', 'text', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('AssetMovement', 'userAssetId', 'text', 'NO', NULL::text, NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('AssetMovement', 'quantityDelta', 'numeric', 'NO', NULL::text, 65, 30, NULL::integer, NULL::integer),
      ('AssetMovement', 'unitPriceUsd', 'numeric', 'YES', NULL::text, 65, 30, NULL::integer, NULL::integer),
      ('AssetMovement', 'priceEstimated', 'bool', 'NO', 'false', NULL::integer, NULL::integer, NULL::integer, NULL::integer),
      ('AssetMovement', 'createdAt', 'timestamp', 'NO', 'CURRENT_TIMESTAMP', NULL::integer, NULL::integer, NULL::integer, 3),
      ('AssetMovement', 'role', 'AssetMovementRole', 'NO', '''PRINCIPAL''::"AssetMovementRole"', NULL::integer, NULL::integer, NULL::integer, NULL::integer)
  ), actual AS (
    SELECT
